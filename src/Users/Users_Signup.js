...
export default function Users_Signup() {
  ...
  await db.collection('Profiles').doc(result.user.uid).set({
    name:fname, userid:result.user.uid,email:email,as:"user",status:"Active"
  })
  
  // router.push("/Screens/Login")
  history.push('/users_login')
  }catch(err){
        ...
        <div className="col-lg-6 mb-5 mb-lg-0 position-relative">
          ...
          <div className="card bg-glass">
            <div className="card-body px-4 py-4 px-md-5">
                ...
                <div className="text-center">
                  <p className='Apps-text fw-bold fs-6'>Allready Have An Account :<a className='btn btn-warning ms-2 text-white fw-bold' href="/users_login">Login</a></p>
                 
                </div>
                <div className="row">
                  <div className="col-md-6 mb-4">
                    <div className="form-outline">
                      <input value={fname} onChange={(e) => setfname(e.target.value)} type="text" id="form3Example1" className="form-control" />
                      <label className="form-label" for="form3Example1">First name</label>
                    </div>
                  </div>
                  <div className="col-md-6 mb-4">
                    <div className="form-outline">
                      <input value={lname} onChange={(e) => setlname(e.target.value)} type="text" id="form3Example2" className="form-control" />
                ...
                <button  onClick={handelsignup} className="btn btn-danger btn-block mb-4">
                  Sign up
                </button>
