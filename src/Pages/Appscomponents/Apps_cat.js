...
export default function Apps_cat(props) {
  ...
  useEffect(() => {
    ...
    const subscriber = db
      .collection("Uploads").where("category","<=",props.title).where("category",">=",props.title).orderBy('category' ,'desc').limit(6)
  ...
  return (
    ...
    <div className='main_container container p-2'>
         <div className='col-sm head_container px-2 py-1 '>
           <div className="d-flex flex-row justify-content-between">
             <div className='col-sm'>
               <h6 className=' Apps-text  fs-5 mt-2 mx-2'>{props.title}</h6>
             </div>
